...
const defaultProps: Props = {
  includePromoCodeInput: true,
  campaignName: 'landing'
}

export default function ApplyLandingForm(props: Props = defaultProps) {
  ...
  const onSubmit = (data: ApplyFormData) => {
    ...
    data.customFields = {
      ...
      campaignName: props.campaignName ?? 'landing'
    }
  ...
  return (
    ...
    >
      ...
      {
        props.includePromoCodeInput === true &&
        <div className='pb-3'>
          <Input
